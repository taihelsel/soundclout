const express = require("express"),
    ...
    SongAPIModel = require(".././models/SongAPIKey"),
...
const songUpdateTimer = 600000; // 10 min timer
...
router.post("/", (req, res) => {
    ...
    songdataHelpers.handleAPIKey(SongAPIModel, (APIKEY) => {
        ...
        SongDataModel.findOne({ url: targetUrl }, function (err, song) {
            if (err) console.log("song err " + err);
                ...
                if (song.lastUpdated <= diff) {
                    ...
                    songdataHelpers.reqSong(song.songId, APIKEY, (err, songData) => {
                            ...
                            if (songdataHelpers.shouldUpdate(latestData, songData)) {
                                ...
                                songdataHelpers.updateSongInDB(song, songData, (err, song) => {
                                    if (err) console.log("error updating song in database.", err);
                                        ...
                                        songdataHelpers.reqRelatedSongs(song.songId, APIKEY, relatedSongLimit, (err, relatedSongList) => {
